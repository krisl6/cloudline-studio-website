...
export const metadata: Metadata = {
  title: "Build Your Second Brain & Automate Your Marketing with Agentic AI",
  description:
  ...
  openGraph: {
    title: "Build Your Second Brain & Automate Your Marketing with Agentic AI | CloudLine Studio",
    description:
