...
const PAIN_POINTS = [
  "Burning ad budget on traffic that never converts to trials",
  "Trial sign-ups but nobody upgrades to paid",
  "Generic messaging that sounds like every other SaaS out there",
  "Marketing team guessing which channel actually drives MRR",
]
...
export default function SaasMarketingLP() {
  return (
          ...
          <div className="container px-4 md:px-6">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight">
                SaaS marketing that feels broken usually is
              </h2>
            </motion.div>
