...
import { CheckCircle2, Eye, Sparkles, TrendingUp } from "lucide-react"
...
const PAIN_POINTS = [
  "Great content that gets 200 likes but zero DMs or website clicks",
  "Algorithm changes tanking your reach every other month",
  "Posting consistently but follower count just won't move",
  "Running ads but the ROAS doesn't make sense for a beauty brand",
]

const AUDIT_DELIVERS = [
  { icon: Eye, title: "Content & reach audit", desc: "Why your content isn't converting viewers to buyers" },
  { icon: Sparkles, title: "Brand positioning check", desc: "Whether your aesthetic and messaging attract your ideal customer" },
  { icon: TrendingUp, title: "Growth roadmap", desc: "3 channel and content shifts to drive real audience growth" },
]

export default function BeautyBrandMarketingLP() {
  return (
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 pt-20 pb-16 md:pt-28 md:pb-24">
            <motion.div variants={stagger} initial="hidden" animate="show" className="mx-auto max-w-3xl text-center">
              <motion.p variants={fadeUp} className="text-xs sm:text-sm font-medium tracking-[0.18em] uppercase text-muted-foreground mb-6">
                Free Beauty Brand Marketing Audit
              </motion.p>
          ...
          <div className="container px-4 md:px-6">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight">
                Beautiful brand. Invisible to buyers.
              </h2>
            </motion.div>
        ...
        <section className="w-full py-16 md:py-24 border-t border-border">
          <div className="container px-4 md:px-6">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight">
                An honest look at what's holding your brand back
              </h2>
            </motion.div>
        ...
        <section className="w-full py-12 border-t border-border">
          <div className="container px-4 md:px-6 text-center">
            <p className="text-xs font-medium tracking-[0.18em] uppercase text-muted-foreground mb-2">Trusted by beauty and lifestyle brands</p>
            <p className="text-sm text-muted-foreground max-w-xl mx-auto">
              CloudLine has run influencer, social, and performance campaigns for beauty, wellness, and lifestyle brands across SEA.
            </p>
          </div>
        </section>
