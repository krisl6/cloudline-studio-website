export const translations = {
  en: {
    ...
    journey: {
      ...
      heading: "From stranger to brand advocate",
      subcopy:
        "Every interaction matters. We strategically design each touchpoint to move your audience through a carefully crafted journey that builds trust, demonstrates value, and creates lasting connections.",
      phases: [
        {
          phase: "Awareness",
        ...
        },
        {
          ...
          title: "Brand Loyalty",
          description:
            "Delighted customers become passionate brand advocates, driving organic growth through referrals and word-of-mouth.",
          details: [
  ...
  ms: {
    ...
    journey: {
      ...
      phases: [
        ...
        {
          phase: "Pertimbangan",
          title: "Hubungan Jenama",
          description:
            "Bakal pelanggan berhubung secara emosi dengan kisah, nilai, dan mesej tulen jenama anda yang menyentuh keperluan mereka.",
          details: [
        ...
        },
        {
          ...
          details: [
            ...
            "Pengalaman pelanggan lancar merentasi semua titik sentuh",
            "Elemen pengurangan risiko yang memudahkan keputusan",
          ],
        },
        {
          phase: "Advokasi",
          title: "Kesetiaan Jenama",
          description:
            "Pelanggan yang berpuas hati menjadi penyokong jenama yang bersemangat, memacu pertumbuhan organik melalui rujukan dan dari mulut ke mulut.",
          details: [
            "Pengalaman jenama luar biasa yang melebihi jangkaan",
            "Interaksi mudah diingat yang ingin dikongsi pelanggan",
            "Pembinaan komuniti yang memupuk hubungan jangka panjang",
            "Sistem rujukan yang memberi ganjaran kepada advokasi jenama",
          ],
        },
      ],
    ...
    values: {
      eyebrow: "Nilai Kami",
      heading: "Apa yang memacu setiap perkara yang kami lakukan",
    ...
    journey: {
      ...
      phases: [
        ...
        },
        {
          ...
          title: "品牌联结",
          description:
            "潜在客户与你的品牌故事、价值观和真实信息产生情感联结，触动他们的需求。",
          details: [
            "真实的品牌叙事，建立情感联结",
            "一致的信息，强化你的独特价值",
            "社会证明和客户评价，建立可信度",
        ...
        },
        {
          ...
          title: "品牌忠诚",
          description:
            "满意的客户成为充满热情的品牌拥护者，通过推荐和口碑推动有机增长。",
          details: [
            "超越期待的卓越品牌体验",
            "令人难忘、客户乐于分享的互动",
            "社群建设，培养长期关系",
