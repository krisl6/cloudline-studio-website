...
const PAIN_POINTS = [
  ...
  "Trial sign-ups look healthy but paid conversion stays flat",
  "No repeatable GTM motion — each new customer feels like a one-off",
  "Content and SEO output with no clear line to demos or revenue",
]

const AUDIT_DELIVERS = [
  { icon: Target, title: "GTM gap analysis", desc: "Where your ICP, channels, and messaging are misaligned and why deals stall" },
  { icon: BarChart2, title: "Pipeline attribution audit", desc: "Which activities are actually driving qualified leads — and what's just noise" },
  { icon: Zap, title: "30-day action plan", desc: "3 specific, prioritised fixes your team can execute in the next month" },
]

export default function TechLP() {
  return (
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6 pt-20 pb-16 md:pt-28 md:pb-24">
            <motion.div variants={stagger} initial="hidden" animate="show" className="mx-auto max-w-3xl text-center">
              ...
              <motion.h1 variants={fadeUp} className="font-display text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-balance leading-[1.05] mb-6">
                Is your tech startup's marketing building real pipeline?
              </motion.h1>
              <motion.p variants={fadeUp} className="mx-auto max-w-2xl text-base sm:text-lg text-muted-foreground leading-relaxed mb-9">
                Most early-stage tech companies run marketing that feels busy but doesn't compound. We'll audit your GTM motion in 48 hours and show you exactly what to fix — for free.
              </motion.p>
          ...
          <div className="container px-4 md:px-6">
            <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight">
                Tech marketing that doesn't compound usually has a structural problem
              </h2>
            </motion.div>
        ...
        <section className="w-full py-12 border-t border-border">
          <div className="container px-4 md:px-6 text-center">
            <p className="text-xs font-medium tracking-[0.18em] uppercase text-muted-foreground mb-2">Trusted by growth-stage teams</p>
            <p className="text-sm text-muted-foreground max-w-xl mx-auto">
              CloudLine has run performance marketing for 50+ brands across SaaS, e-commerce, health, and education.
            </p>
          </div>
        </section>
