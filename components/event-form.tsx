...
const T = {
  en: {
    ...
    namePh: "Your name", emailPh: "you@company.com", phonePh: "12 345 6789", businessPh: "e.g. a B2B SaaS or marketing automation tool",
    participantsPh: "e.g. 30", audiencePh: "e.g. Marketers, founders, ops teams",
    goalPh: "e.g. Get 30 marketers hands-on with our platform and book demos",
  ...
  ms: {
    ...
    namePh: "Nama anda", emailPh: "anda@syarikat.com", phonePh: "12 345 6789", businessPh: "cth. alat SaaS B2B atau automasi pemasaran",
    participantsPh: "cth. 30", audiencePh: "cth. Pemasar, pengasas, pasukan operasi",
    goalPh: "cth. Beri 30 pemasar mencuba platform kami dan tempah demo",
  ...
  zh: {
    ...
    namePh: "您的姓名", emailPh: "you@company.com", phonePh: "12 345 6789", businessPh: "例如：B2B SaaS 或营销自动化工具",
    participantsPh: "例如：30", audiencePh: "例如：营销人员、创始人、运营团队",
    goalPh: "例如：让 30 位营销人员亲身体验我们的平台并预约演示",
